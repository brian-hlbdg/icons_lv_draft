defmodule IconsLvDraftWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IconsLvDraftWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IconsLvDraftWeb.Gettext, "errors", msg, opts)
    end
  end
